...
class CirclesViewController: UIViewController {
    ...
    private let circlesView = CirclesView()

    override func viewDidLoad() {
        super.viewDidLoad()
        view.backgroundColor = .black

        colors = calculateColorPercentages(from: emotionColors) 

        setupLayout()
        circlesView.configure(with: colors)
    }
    ...
    private func setupLayout() {
        ...
        NSLayoutConstraint.activate([
            ...
            circlesView.topAnchor.constraint(equalTo: columnLabel.bottomAnchor, constant: -275),
