...
class EmotionCardView: UIView {
    ...
    private func setupButton(buttonColor: UIColor, text: String) {
        ...
        emotionLabel.font = UIFont(name: "Gwen-Trial-Bold", size: UIScreen.main.bounds.width / 15)
        ...
        NSLayoutConstraint.activate([
            ...
            emotionLabel.topAnchor.constraint(equalTo: feelingLabel.bottomAnchor, constant: 8),
            emotionLabel.bottomAnchor.constraint(lessThanOrEqualTo: contentView.bottomAnchor, constant: -16)
        ])
